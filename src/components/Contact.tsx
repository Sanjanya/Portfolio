    ...
    <section id="contact" className="py-20 px-6 bg-slate-50">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-16">
          {/* Email */}
          <a
            href="mailto:contactsanjuas@gmail.com"
            target="_blank"
          ...
          >
            <div className="bg-white p-8 rounded-2xl shadow-sm border border-slate-200 hover:shadow-xl hover:shadow-blue-500/10 transition-all duration-300 hover:-translate-y-2">
              ...
              <p className="text-slate-600 font-mono text-sm">contactsanjuas@gmail.com</p>
            </div>
          </a>

          {/* LinkedIn */}
          <a
            href="https://www.linkedin.com/in/sanjanya-srinivasan-02248a19a/"
            target="_blank"
            rel="noopener noreferrer"
            className="group"
          >
            <div className="bg-white p-8 rounded-2xl shadow-sm border border-slate-200 hover:shadow-xl hover:shadow-purple-500/10 transition-all duration-300 hover:-translate-y-2">
              ...
              <p className="text-slate-600 font-mono text-sm">/sanjanya-srinivasan-02248a19a</p>
            </div>
          </a>

          {/* GitHub */}
          <a
            href="https://github.com/Sanjanya"
            target="_blank"
            rel="noopener noreferrer"
            className="group"
          >
            <div className="bg-white p-8 rounded-2xl shadow-sm border border-slate-200 hover:shadow-xl hover:shadow-green-500/10 transition-all duration-300 hover:-translate-y-2">
              ...
              <p className="text-slate-600 font-mono text-sm">/Sanjanya</p>
            </div>
          </a>
        </div>
        ...
        <a
          href="mailto:contactsanjuas@gmail.com"
          className="inline-block px-10 py-4 bg-gradient-to-r from-cyan-500 to-blue-600 text-white rounded-xl hover:from-cyan-600 hover:to-blue-700 transition-all duration-300 shadow-lg hover:shadow-cyan-500/25 font-semibold text-lg"
        >
